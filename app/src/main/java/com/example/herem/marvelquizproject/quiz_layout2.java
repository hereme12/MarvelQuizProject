...
public class quiz_layout2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_layout2);
    ...
    private void completeIntent(String enteredName, int questionCounter, String summaryResponses, int numberCorrect){
        ...
        Intent intent = new Intent(getApplicationContext(), quiz_layout3.class);
