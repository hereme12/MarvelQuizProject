...
public class quiz_layout3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_layout3);
    ...
    private void completeIntent(String enteredName, int questionCounter, String summaryResponses, int numberCorrect){
        ...
        Intent intent = new Intent(getApplicationContext(), quiz_layout4.class);
