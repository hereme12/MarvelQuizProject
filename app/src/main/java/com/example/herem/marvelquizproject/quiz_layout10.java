...
public class quiz_layout10 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_layout10);
    ...
    public void submitAnswer(View view) {
        ...
        completeIntent(fullName, questionCorrect, correctMessage);
     ...
     */
    private void completeIntent(String enteredName, String summaryResponses, String summaryCorrect){
        //Intent used to switch to quiz_layout
        Intent intent = new Intent(getApplicationContext(), summary_layout.class);
        ...
        //Send summary of correct responses
        intent.putExtra("summaryTotalCorrect", summaryCorrect);
